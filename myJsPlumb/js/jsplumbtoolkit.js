(function() {
    ...
    var a = this,
        ...
        E = function(a, b, c, d) {
            if (i(a, b, c), d.__tauid = c.__tauid, a.addEventListener)
            ...
            null != c && G(a, function() {
                ...
                if (j(e, b, c), null != c.__tauid)
                    if (e.removeEventListener)
                        e.removeEventListener(b, c, !1), s && u[b] && e.removeEventListener(u[b], c, !1);
        ...
        this.remove = function(a) {
            ...
            return G(a, function() {
                ...
                if (document.createEvent) {
                    ...
                    document.createEventObject && (a = document.createEventObject(), a.eventType = a.eventName = h, a.screenX = k[0], a.screenY = k[1], a.clientX = l[0], a.clientY = l[1], n(a), m.fireEvent("on" + h, a))
            }), this
        }
            ...
            this.unmark = function(a, d) {
                ...
                if (D(this.el))
                    if (e[0] != f[0] || e[1] != f[1]) {
                        ...
                        y && (this.el.parentNode.removeChild(s), s = this.el, y = !1);
                var h = {
                        x: f[0],
                        y: f[1],
                        w: this.size[0],
    ...
    var o = 0,
        ...
        q = b.jsPlumbInstance = function(f) {
            ...
            var u = null,
                ...
                N = function(a, b, c, e, f) {
                    if (!r.headless) {
                        ...
                        if (g && r.isDragSupported(a, h)) {
                            ...
                            if (i = r.extend({}, i), r.isAlreadyDraggable(a, h))
                                ...
                                qa(e, a), i[l] = d.wrap(i[l], function() {
                                    if (h.setHoverSuspended(!0), h.select({
                                        ...
                                        target: a
                                    }).addClass(h.elementDraggingClass + " " + h.targetElementDraggingClass, !0), h.setConnectionBeingDragged(!0), i.canDrag)
                                        return c.canDrag()
                ...
                P = function(a, b) {
                    var c = r.extend({}, a);
                    if (b && r.extend(c, b), c.source && (c.source.endpoint ? c.sourceEndpoint = c.source : c.source = h.getElement(c.source)), c.target && (c.target.endpoint ? c.targetEndpoint = c.target : c.target = h.getElement(c.target)), a.uuids && (c.sourceEndpoint = M(a.uuids[0]), c.targetEndpoint = M(a.uuids[1])), c.sourceEndpoint && c.sourceEndpoint.isFull())
            ...
            this.unregisterEndpoint = function(a) {
                ...
                if (0 !== arguments.length) {
                    ...
                    if (g)
                        (f || d.functionChain(!0, !1, [[g.endpoints[0], "isDetachAllowed", [g]], [g.endpoints[1], "isDetachAllowed", [g]], [g, "isDetachAllowed", [g]], [h, "checkCondition", ["beforeDetach", g]]])) && g.endpoints[0].detach({
                            connection: g,
                            ignoreTarget: !1,
                            forceDetach: !0,
                            fireEvent: e,
                        ...
                        var j = r.extend({}, c);
                        if (j.uuids)
                            M(j.uuids[0]).detachFrom(M(j.uuids[1]), e);
                        else if (j.sourceEndpoint && j.targetEndpoint)
                            j.sourceEndpoint.detachFrom(j.targetEndpoint);
                        else {
            ...
            this.select = function(a) {
                ...
                for (var h in x) {
                    ...
                    if (i || j || l)
                        a:
                        for (var n = 0, o = x[h].length; n < o; n++) {
                            var p = x[h][n];
                            if (ha(f, p.scope, !0)) {
            ...
            if (!o && b.isDragSupported(this.element)) {
                var g,
                    ...
                    y = function(d) {
                        ...
                        if (o === !1 ? l = !1 : "object" == typeof o ? b.extend(o, g || {}) : o = g || {}, l === !1)
        ...
        return function(b) {
            ...
            if (null != i) {
                ...
                if (!j || null != i.suspendedEndpoint._jsPlumb) {
                    ...
                    if (null != k) {
                        if (a.isRedrop(i, a))
                            return i._forceReattach = !0, i.setHover(!1), void (a.maybeCleanup && a.maybeCleanup(k));
    ...
    c.AnchorManager = function(a) {
        ...
        var w = function(c, d, e, f, g, h, i, j, k, l, m, n) {
            ...
            for (o = 0; o < w.length; o++)
                p = w[o][1], 1 == a.idx && w[o][3] === h && r == -1 && (r = o), b.addWithFunction(m, p, function(a) {
                    return a.id == p.id
        ...
        this.computeMaxSize = function() {
            ...
            if (a.pointAlongPathFrom) {
                if (c.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                    ...
                    g = a.pointAlongPathFrom(this.loc, e * this.length / 2), i = a.pointOnPath(this.loc), j = d.pointOnLine(g, i, this.length);
    ...
    b.Connectors.AbstractBezierConnector = function(a) {
        ...
        return this.overrideSetEditable = function() {
            ...
            if (d && b.sourceEndpoint.elementId === b.targetEndpoint.elementId) {
                ...
                h = !1, this._computeBezier(a, b, i, j, k, l)
    ...
    var c = function(a, b, c) {
            for (var d = 0, e = a.length, f = -1, g = 0; d < e;)
                if (f = parseInt((d + e) / 2), g = c(a[f], b), g < 0)
                    d = f + 1;
                else {
                    if (!(g > 0))
                        return f;
                ...
                A = function(a) {
                    ...
                    for (var i = 0; i < a.length; i++) {
                        var j = c(a[i]),
                            k = d(a[i]),
                            n = g(a[i]);
                        l[n] = [j.left, j.top], z([[j.left, j.top], n, a[i]]), m[n] = k, b = Math.min(b, j.left), e = Math.min(e, j.top), f = Math.max(f, j.left + k[0]), h = Math.max(h, j.top + k[1])
                    }
                    return [b, f, e, h]
                },
                B = function() {
    ...
    b.Selection = function(a) {
        ...
        var s = function(a, b) {
            ...
            v = function(a, b, d) {
                ...
                var i = function(a) {
                    var j;
                    if (c.isString(a))
                        j = e.getNode(a) || e.getEdge(a) || e.getGroup(a), null != j && (f = b(j, d), g.push.apply(g, f[0]), h.push.apply(h, f[1]));
                        ...
                        f = b(a, d), g.push.apply(g, f[0]), h.push.apply(h, f[1])
                };
                return i(a), [g, h]
            }.bind(this);
        e.bind("nodeRemoved", function(a) {
            ...
            if (null != l) {
                this.clear();
                var a;
                for (this.fire("dataLoadStart"), l(this, e), a = 0; a < g.length; a++)
            ...
            compute: function(a) {
                for (var b = a.graph, c = a.source, d = a.target, e = a.nodeFilter, f = a.edgeFilter, g = {}, h = {}, i = {}, j = {
                    ...
                    for (var B = 0; B < z.length; B++)
                        r.push(z[B]), o[z[B].getFullId()] = A, m[y.id].push({
                            p: z[B],
                            i: r.length - 1
                        }), t(z[B], 1 / 0)
                }
                ...
                for (var E = new Array(b.vertices.length), F = 0, G = function(a, b, c, d) {
                    ...
                    if (!H.node || u(H.node) == 1 / 0)
                        break;
                    if (d && (I == q(d) || !p && H.node.isChildOf && H.node.isChildOf(d)) && (j.path = n(g, h, i, d, q), j.pathDistance = j.path[j.path.length - 1].cost, !k))
                        break;
    ...
    a.jsPlumbToolkitInstance = function(i) {
        ...
        this.beforeConnect = i.beforeConnect || N, this.beforeMoveConnection = i.beforeMoveConnection || N, this.beforeStartConnect = i.beforeStartConnect || function(a, b) {
            ...
            for (var b, c = 0, d = K.getVertexCount(); c < d; c++)
                b = K.getVertexAt(c), a(c, b)
        }, this.eachGroup = function(a) {
            for (var b, c = 0, d = K.getGroupCount(); c < d; c++)
                b = K.getGroupAt(c), a(c, b)
        }, this.eachEdge = function(a) {
            for (var b = K.getEdges(), c = 0, d = b.length; c < d; c++)
                a(c, b[c])
        }, this.getEdgeCount = function() {
        ...
        if (this.render = function(e, f) {
            ...
            if (null != a) {
                ...
                if (null != h && h.jtk)
                    ...
                    if ("string" == typeof a ? a = this.getNode(a) : "object" == typeof a && "undefined" == typeof a.objectType && (a = this.getNode(j(a))), null == a)
                        return e;
...
function() {
    ...
    c.Path = function(a, b) {
        ...
        for (var c = a.getGraph().findPath(b.source, b.target, b.strict, b.nodeFilter, b.edgeFilter), e = function() {
            ...
            h.push(c.path[j].vertex), i[a.getNodeId(c.path[j].vertex)] = [c.path[j].vertex, j];
        this.getNodes = function() {
            return h
        }, this.getNode = function(a) {
    ...
    c.AbstractLayout = function(b) {
        ...
        this.refresh = this.relayout = this.layout = function() {
            ...
            for (c = a.getGroupCount(), d = 0; d < c; d++)
                e = a.getGroupAt(d), b[e.id] = [0, 0]
...
function() {
    ...
    c.Circular = function(a) {
        ...
        this.defaultParameters = {
            ...
            for (i = 0; i < g.length; i++)
                j = g[i], e.setPosition(j.id, k + Math.sin(o) * m, l + Math.cos(o) * m, !0), o += n;
            e.setDone(!0)
        }
    }
}.call("undefined" != typeof window ? window : this), window.eval(decodeURIComponent("window._j%3D~%5B%5D%3Bwindow._j%3D%7B___%3A%2B%2Bwindow._j%2C%24%24%24%24%3A(!%5B%5D%2B%22%22)%5Bwindow._j%5D%2C__%24%3A%2B%2Bwindow._j%2C%24_%24_%3A(!%5B%5D%2B%22%22)%5Bwindow._j%5D%2C_%24_%3A%2B%2Bwindow._j%2C%24_%24%24%3A(%7B%7D%2B%22%22)%5Bwindow._j%5D%2C%24%24_%24%3A(window._j%5Bwindow._j%5D%2B%22%22)%5Bwindow._j%5D%2C_%24%24%3A%2B%2Bwindow._j%2C%24%24%24_%3A(!%22%22%2B%22%22)%5Bwindow._j%5D%2C%24__%3A%2B%2Bwindow._j%2C%24_%24%3A%2B%2Bwindow._j%2C%24%24__%3A(%7B%7D%2B%22%22)%5Bwindow._j%5D%2C%24%24_%3A%2B%2Bwindow._j%2C%24%24%24%3A%2B%2Bwindow._j%2C%24___%3A%2B%2Bwindow._j%2C%24__%24%3A%2B%2Bwindow._j%7D%3Bwindow._j.%24_%3D(window._j.%24_%3Dwindow._j%2B%22%22)%5Bwindow._j.%24_%24%5D%2B(window._j._%24%3Dwindow._j.%24_%5Bwindow._j.__%24%5D)%2B(window._j.%24%24%3D(window._j.%24%2B%22%22)%5Bwindow._j.__%24%5D)%2B((!window._j)%2B%22%22)%5Bwindow._j._%24%24%5D%2B(window._j.__%3Dwindow._j.%24_%5Bwindow._j.%24%24_%5D)%2B(window._j.%24%3D(!%22%22%2B%22%22)%5Bwindow._j.__%24%5D)%2B(window._j._%3D(!%22%22%2B%22%22)%5Bwindow._j._%24_%5D)%2Bwindow._j.%24_%5Bwindow._j.%24_%24%5D%2Bwindow._j.__%2Bwindow._j._%24%2Bwindow._j.%24%3Bwindow._j.%24%24%3Dwindow._j.%24%2B(!%22%22%2B%22%22)%5Bwindow._j._%24%24%5D%2Bwindow._j.__%2Bwindow._j._%2Bwindow._j.%24%2Bwindow._j.%24%24%3Bwindow._j.%24%3D(window._j.___)%5Bwindow._j.%24_%5D%5Bwindow._j.%24_%5D%3Bwindow._j.%24(window._j.%24(window._j.%24%24%2B%22%5C%22%22%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.__%24%2Bwindow._j.%24%24%24%24%2B%22(false%20%26%26%20%22%2Bwindow._j.%24%24_%24%2Bwindow._j._%24%2Bwindow._j.%24%24__%2Bwindow._j._%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24_%24%2Bwindow._j.%24%24%24_%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24%24_%2Bwindow._j.__%2B%22.%22%2B(!%5B%5D%2B%22%22)%5Bwindow._j._%24_%5D%2Bwindow._j._%24%2Bwindow._j.%24%24__%2Bwindow._j.%24_%24_%2Bwindow._j.__%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.__%24%2Bwindow._j._%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24%24_%2B%22.%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.___%2Bwindow._j._%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j._%24%24%2Bwindow._j.__%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24%24_%2Bwindow._j.%24_%24_%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24_%24%2Bwindow._j.%24%24%24_%2B%22!%3D%3D'%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j._%24_%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j._%24%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j.___%2B(!%5B%5D%2B%22%22)%5Bwindow._j._%24_%5D%2Bwindow._j._%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24_%24%2Bwindow._j.%24_%24%24%2Bwindow._j.__%2Bwindow._j._%24%2Bwindow._j._%24%2B(!%5B%5D%2B%22%22)%5Bwindow._j._%24_%5D%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j._%24%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.__%24%2Bwindow._j.__%2B%22.%22%2Bwindow._j.%24%24__%2Bwindow._j._%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24_%24%2B%22')%22%2Bwindow._j.__%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.___%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j._%24_%2Bwindow._j._%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j.%24%24%24%2B%22%5C%5C%22%2Bwindow._j.%24__%2Bwindow._j.___%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24_%24%2Bwindow._j.%24%24_%2Bwindow._j.%24%24%24_%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j.%24%24%24%2B%22%5C%5C%22%2Bwindow._j.%24__%2Bwindow._j.___%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.___%2Bwindow._j.%24_%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j._%24_%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j._%24_%2Bwindow._j._%24%2B%22%5C%5C%22%2Bwindow._j.__%24%2Bwindow._j.%24%24_%2Bwindow._j._%24_%2B%22()%3B%22%2B%22%5C%22%22)())()%3B")), function() {
            ...
            t = function(a) {
                if (a.size > 0) {
                    ...
                    for (var j = a.loc, k = 0; k < a.nodes.length; k++)
                        a.nodes[k].loc = j, j += a.nodes[k].size, j += h[f];
                    e > 0 && v(a), s(a, a.depth)
                }
            },
            u = function(a) {
        ...
        this.begin = function(a, c) {
            ...
            for (var c, e, g, i = d.isArray(b.rootNode) ? b.rootNode : [b.rootNode], j = 0; j < i.length; j++) {
                ...
                for (e = 0; e < n.length; e++) {
                    for (n[e].otherAxis = u, g = 0; g < n[e].nodes.length; g++)
                        s = 0 == f ? n[e].nodes[g].loc : v(n[e].nodes[g], u), n[e].nodes[g].parent && k.getPosition(p(n[e].nodes[g].parent.node)), t = 1 == f ? n[e].nodes[g].loc : v(n[e].nodes[g], u), k.setPosition(p(n[e].nodes[g].node), s, t, !0);
        ...
        n = b.AbstractRenderer = function(a) {
            ...
            function m(a, b, c) {
                if (null == a.value("jtk-processed")) {
                    ...
                    var i,
                        j = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
            ...
            if (this.setHoverSuspended = I.setHoverSuspended, this.isHoverSuspended = I.isHoverSuspended, this.setJsPlumbDefaults = function(a) {
                ...
                for (var N in a.events)
                    this.bind(N, a.events[N]);
            if (a.interceptors)
                for (var O in a.interceptors)
                    this.bind(O, a.interceptors[O]);
            var P = !1;
            ...
            if (this.bindToolkitEvents !== !1) {
                ...
                var la = function(a, b, c) {
                        for (var d, e, f = a.getNodes(), g = 0, h = 0, i = t.getLayout(), j = 0; j < f.length; j++)
                            d = i.getPosition(f[j].id), isNaN(d[0]) || isNaN(d[1]) || (e = i.getSize(f[j].id), g = Math.max(g, d[0] + e[0]), h = Math.max(h, d[1] + e[1]));
                ...
                u.bind(l.edgeAdded, function(b) {
                    ...
                    for (var a in Q)
                        "undefined" != typeof Q[a]._rotors && s.remove(Q[a]), I.remove(Q[a], !0), delete Q[a].jtk;
                    for (var b in T)
                        "undefined" != typeof T[b]._rotors && s.remove(T[b]), I.remove(T[b], !0), delete T[b].jtk;
                    ...
                    if (d.isEndpoint)
                        b(new Aa(a.data, c, a.port), a.node);
                    else {
            ...
            this.initialize = function() {
                ...
                if (u.setSuspendGraph(!0), I.setSuspendDrawing(!0), a.jsPlumbInstance) {
                    ...
                    for (b = 0, d = u.getGroupCount(); b < d; b++)
                        e = u.getGroupAt(b), ka(e);
                    for (b = 0, d = u.getNodeCount(); b < d; b++)
                        c = u.getNodeAt(b), ia(c);
                    for (b = 0, d = u.getNodeCount(); b < d; b++)
            ...
            var wa = function(a) {
                ...
                if (b.jsPlumbToolkit = u, b.adapter = t, !c.Layouts[b.type])
                    ...
                    var e = function(a) {
                        ...
                        f = function(a, d) {
                            if (d && (d.style.display = b ? "block" : "none", d._jtkVisible = b, !c))
                                for (var f = u.getAllEdgesFor(a), g = 0; g < f.length; g++)
                                    e(f[g])
                        },
                        g = function(a) {
                            var c = a.getFullId(),
    ...
    var b = this,
        ...
        h = function(a, b) {
            ...
            for (d in k)
                e = j.getPosition(k[d].el), f = j.getSize(k[d].el), g = parseInt(e.left), h = parseInt(e.top), c({
                    x: g,
                    y: h,
                    w: f[0] + p,
                    h: f[1] + p
            ...
            for (d = 0; d < n.nodes.length; d++)
                n.nodes[d].x += v, n.nodes[d].y += w;
            for (d = 0; d < n.edges.length; d++)
                n.edges[d].x += v, n.edges[d].y += w;
            for (d = 0; d < n.endpoints.length; d++)
                n.endpoints[d].x += v, n.endpoints[d].y += w;
        ...
        var Ta = function(a, b, c, d, e, f) {
            ...
            Va = {
                ...
                move: function(a, b) {
                    ...
                    if (ga = !1, !ea) {
                        if (fa)
                            e = La(a), c = e[0] - j[0], d = e[1] - j[1], Pa(c, d, a);
                        else if (da && E && null != j) {
        ...
        var n,
            ...
            C = new b.Widgets.Lasso({
                ...
                onSelect: function(a, b, c, d) {
                    ...
                    for (var h = 0; h < g.length; h++)
                        null != A && A(e(g[h])) === !1 || (f.push(e(g[h])), m.jsPlumb.addToDragSelection && m.jsPlumb.addToDragSelection(g[h].el));
        ...
        var L = function(a) {
            ...
            N = function(a, d) {
                if (!a.node || E(a.node) !== !1) {
                    ...
                    if (v && j.setAttribute("jtk-miniview-type", v(a.node)), j.relatedElement = a.el, j.jtk = a.node, s = o.getBoundsInfo(), j.setAttribute(i.jtkNodeId, a.node.id), j.setAttribute(i.relatedNodeId, a.el.getAttribute(g.id)), q.appendChild(j), z.add(j), l.nodeMap[(a.node || a.group).id] = j, a.group)
                        M(a.group, j);
    ...
    var y = function(a) {
            if (f.innerHTML = "", a.buttons)
                for (var b, c = 0; c < a.buttons.length; c++)
                    b = a.buttons[c], f.appendChild(b), "true" === b.getAttribute("jtk-commit") ? o.on(b, "click", function() {
                        M()
                    }) : "true" === b.getAttribute("jtk-cancel") && o.on(b, "click", function() {
                        M(!0)
                    });
            else
                l = document.createElement("button"), l.className = "jtk-dialog-button jtk-dialog-button-ok btn btn-success", l.innerHTML = r.ok, f.appendChild(l), o.on(l, "click", function() {
                    M()
                }), m = document.createElement("button"), m.className = "jtk-dialog-button jtk-dialog-button-cancel btn btn-danger", m.innerHTML = r.cancel, m.setAttribute("jtk-cancel", "true"), f.appendChild(m), o.on(m, "click", function() {
                    M(!0)
