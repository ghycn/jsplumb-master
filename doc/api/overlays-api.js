...
* @param {String} [labelStyle.fonts] A string specifying a fonts to use, in valid CSS format.
* @param {String} [labelStyle.color] A string specifying a fonts color to use, in valid CSS format.
